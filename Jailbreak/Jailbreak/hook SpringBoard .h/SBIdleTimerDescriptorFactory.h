...
+ (id)idleTimerDescriptorForProvider:(id)arg1;
+ (id)lockScreenIdleTimerDescriptor;
+ (id)autoLockIdleTimerDescriptor;
+ (id)defaultIdleTimerDescriptor;
...
- (_Bool)updateIdleTimerSettingsForWorkspace:(id)arg1;
