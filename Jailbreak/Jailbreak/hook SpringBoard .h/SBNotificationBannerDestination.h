...
@class BSSimpleAssertion, FBUIApplicationSceneDeactivationAssertion, NCNotificationViewController, NSMutableSet, NSString, SBAppStatusBarSettingsAssertion, SBAssistantController, SBLockScreenManager, SBNotificationBannerWindow, SBNotificationLongLookBannerDestination, SBQuietModeStateAggregator, SBSetupManager;
