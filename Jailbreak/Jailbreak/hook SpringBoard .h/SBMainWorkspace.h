...
@class BSEventQueueLock, BSWatchdog, FBDisplayLayoutTransition, FBSceneManager, NSMutableDictionary, NSMutableSet, NSObject, NSSet, NSString, SBAlertManager, SBAppStatusBarSettingsAssertion, SBHomeGestureArbiter, SBIdleTimerCoordinatorHelper, SBMainAlertManager, SBOrientationAggdLogger, SBWindow, SBWindowSelfHostWrapper, SBWorkspaceTransaction;
