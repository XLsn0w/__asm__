...
static void _logos_method$_ungrouped$SBIconView$dockAnimation(_LOGOS_SELF_TYPE_NORMAL SBIconView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
...
static SBIconView* _logos_method$_ungrouped$SBIconView$initWithFrame$(_LOGOS_SELF_TYPE_INIT SBIconView* __unused self, SEL __unused _cmd, struct CGRect arg1) _LOGOS_RETURN_RETAINED {
    [self dockAnimation];
    return _logos_orig$_ungrouped$SBIconView$initWithFrame$(self, _cmd, arg1);
}

static SBIconView* _logos_method$_ungrouped$SBIconView$initWithContentType$(_LOGOS_SELF_TYPE_INIT SBIconView* __unused self, SEL __unused _cmd, unsigned long long arg1) _LOGOS_RETURN_RETAINED {
   [self dockAnimation];
   return _logos_orig$_ungrouped$SBIconView$initWithContentType$(self, _cmd, arg1);
}
