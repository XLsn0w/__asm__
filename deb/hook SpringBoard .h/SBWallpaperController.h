...
@class NSHashTable, NSMutableSet, NSString, SBFWallpaperConfigurationManager, SBFWallpaperSettings, SBFWallpaperView, SBRootSettings, SBWallpaperAggdLogger, SBWallpaperStyleInfo, UIImage, UIScreen, UIView, UIWindow;
