...
@class NSObject, NSString, SBCoverSheetPositionView, SBCoverSheetSystemGesturesDelegate, SBCoverSheetTransitionSettings, SBLockScreenSettings, SBScreenEdgePanGestureRecognizer, UIViewFloatAnimatableProperty;
...
@interface SBCoverSheetSlidingViewController : UIViewController <SBCoverSheetSystemGestureDelegatePositionProviding, _UISettingsKeyObserver>
{
    ...
    double _currentCatchupValue;
    struct CGPoint _lastLocation;
}

@property(nonatomic) double currentCatchupValue; // @synthesize currentCatchupValue=_currentCatchupValue;
