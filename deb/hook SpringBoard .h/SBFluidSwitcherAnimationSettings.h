...
@interface SBFluidSwitcherAnimationSettings : SBUISettings
{
    ...
    SBFluidBehaviorSettings *_statusBarFadeSettings;
...
@property(retain, nonatomic) SBFluidBehaviorSettings *statusBarFadeSettings; // @synthesize statusBarFadeSettings=_statusBarFadeSettings;
